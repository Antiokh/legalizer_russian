...
def test_contractual_profile_enables_party_modality_scope_subject_and_deadline_rules():
...
def test_normative_profile_gets_scope_and_deadline_review_but_not_contract_party_rules():
...
def test_plain_official_admin_gets_deadline_but_not_contract_scope_or_subject_rules():
